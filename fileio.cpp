...
namespace FileIO {
    ...
    bool WriteSystemInfoToFile(const std::wstring& content, std::wstring& err) {
        ...
        // Fixed path
        const std::wstring fixedPath = L"C:\\Facultate\\CSSO\\FinalWeek\\info.txt";
    ...
    std::wstring GetStaticResultsPath() {
        return L"C:\\Facultate\\CSSO\\FinalWeek\\rezultate\\static";
    }

    std::wstring GetDynamicResultsPath() {
        return L"C:\\Facultate\\CSSO\\FinalWeek\\rezultate\\dinamic";
    }
    ...
    bool EnsureResultsFolders(std::wstring& err) {
        ...
        // Base results folder
        const std::wstring baseResultsPath = L"C:\\Facultate\\CSSO\\FinalWeek\\rezultate";
